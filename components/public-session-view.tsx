          ...
          const mockData = [
            {
              ...
              session_data: {
                ...
                likes: 124,
                is_public: true,
                propositoSesion: "Comprender la relación entre fracciones y números decimales aplicados en compras y descuentos.",
                competenciaDescripcion: "Resuelve problemas de cantidad: Traduce cantidades a expresiones numéricas.",
                secuenciaMetodologica: {
                  inicio: "Presentación de un recibo de supermercado. Preguntas sobre los decimales.",
                  desarrollo: "Trabajo en grupos para convertir fracciones a decimales usando productos reales.",
                  cierre: "Reflexión sobre el uso de decimales para no ser estafados en las compras."
                }
              }
            },
            {
              ...
              session_data: {
                ...
                competenciaDescripcion: "Resuelve problemas de regularidad, equivalencia y cambio.",
                secuenciaMetodologica: {
                  inicio: "Debate sobre los kilos de basura generados. Planteamiento del problema.",
                  desarrollo: "Uso de ecuaciones para calcular proyecciones de contaminación.",
                  cierre: "Elaboración de un informe matemático."
                }
              }
            }
          ]
          const mockFound = mockData.find(s => s.id === id)
          if (mockFound) setSession(mockFound)
        }
      } catch (err) {
