...
export const translations: Record<Language, TranslationDictionary> = {
  es: {
    ...
    whyChooseSubtitle: "Olvídate de empezar desde cero. Sesión + agiliza tu planificación pedagógica para que te enfoques en lo que realmente importa: enseñar y conectar con tus estudiantes.",
    ...
    interactiveDemoDesc: "Experimenta con nuestra demo interactiva de Sesión + y descubre el poder de la planificación con IA.",
  ...
  en: {
    ...
    whyChooseSubtitle: "Forget about starting from scratch. Sesión + speeds up your lesson planning so you can focus on what really matters: teaching and connecting with your students.",
    ...
    interactiveDemoDesc: "Experiment with our interactive Sesión + demo and discover the power of AI planning.",
  ...
  qu: {
    ...
    whyChooseSubtitle: "Qallariymanta ama ruraychu. Sesión + yachachiy planifikacionniykita utqayman purichin, yachachiypi wawakunawan tupanaykipaq.",
    ...
    interactiveDemoDesc: "Sesión + IA yachachiyta qaway, imaynam ratulla yachachiyta ruran.",
  ...
  ay: {
    ...
    whyChooseSubtitle: "Qalltañatakix janiw cusa lurañakiti. Sesión + lurañampix jank'akiw planifiqt'ata, wawanakampi yatichañataki.",
    ...
    interactiveDemoDesc: "Uñancht'awi demo interactiva Sesión + IA-mpi luri uk uñjaña.",
